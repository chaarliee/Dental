...
namespace Dental.DentalDataSet2TableAdapters {
...
SELECT Id, first_name, last_name, address, phone, email, DOB, gender, created_At FROM Patients WHERE (Id = @Id)";
        ...
        public virtual int Fill(DentalDataSet2.PatientsDataTable dataTable) {
        ...
        public virtual DentalDataSet2.PatientsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DentalDataSet2.PatientsDataTable dataTable = new DentalDataSet2.PatientsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DentalDataSet2.PatientsDataTable dataTable) {
