...
namespace Dental {
    ...
    public partial class Patients : global::System.Data.DataSet {
        ...
        public PatientsDataTable _Patients {
            get {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private bool ShouldSerialize_Patients() {
            return false;
        }
        ...
        public partial class PatientsDataTable : global::System.Data.TypedTableBase<PatientsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PatientsRow AddPatientsRow(string first_name, string last_name, string address, string phone, string email, string DOB, string gender, string created_At) {
            ...
            private void InitClass() {
                ...
                this.ExtendedProperties.Add("Generator_TablePropName", "_Patients");
                this.ExtendedProperties.Add("Generator_UserTableName", "Patients");
            }
...
namespace Dental.PatientsTableAdapters {
    ...
    public partial class PatientsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Patients] ([first_name], [last_name], [address], [phone], [email], [DOB], [gender], [created_At]) VALUES (@first_name, @last_name, @address, @phone, @email, @DOB, @gender, @created_At);
SELECT Id, first_name, last_name, address, phone, email, DOB, gender, created_At FROM Patients WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Patients] SET [first_name] = @first_name, [last_name] = @last_name, [address] = @address, [phone] = @phone, [email] = @email, [DOB] = @DOB, [gender] = @gender, [created_At] = @created_At WHERE (([Id] = @Original_Id) AND ((@IsNull_first_name = 1 AND [first_name] IS NULL) OR ([first_name] = @Original_first_name)) AND ((@IsNull_last_name = 1 AND [last_name] IS NULL) OR ([last_name] = @Original_last_name)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_DOB = 1 AND [DOB] IS NULL) OR ([DOB] = @Original_DOB)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_created_At = 1 AND [created_At] IS NULL) OR ([created_At] = @Original_created_At)));
SELECT Id, first_name, last_name, address, phone, email, DOB, gender, created_At FROM Patients WHERE (Id = @Id)";
        ...
        public virtual int Fill(Patients.PatientsDataTable dataTable) {
        ...
        public virtual Patients.PatientsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        public virtual int Insert(string first_name, string last_name, string address, string phone, string email, string DOB, string gender, string created_At) {
            if ((first_name == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_gender, 
                    string Original_created_At) {
            return this.Update(first_name, last_name, address, phone, email, DOB, gender, created_At, Original_Id, Original_first_name, Original_last_name, Original_address, Original_phone, Original_email, Original_DOB, Original_gender, Original_created_At, Original_Id);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        private int UpdateUpdatedRows(Patients dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._patientsTableAdapter != null)) {
                global::System.Data.DataRow[] updatedRows = dataSet._Patients.Select(null, null, global::System.Data.DataViewRowState.ModifiedCurrent);
        ...
        private int UpdateInsertedRows(Patients dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._patientsTableAdapter != null)) {
                global::System.Data.DataRow[] addedRows = dataSet._Patients.Select(null, null, global::System.Data.DataViewRowState.Added);
                if (((addedRows != null) 
                            && (0 < addedRows.Length))) {
        ...
        private int UpdateDeletedRows(Patients dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._patientsTableAdapter != null)) {
                global::System.Data.DataRow[] deletedRows = dataSet._Patients.Select(null, null, global::System.Data.DataViewRowState.Deleted);
                if (((deletedRows != null) 
