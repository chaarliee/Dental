...
SELECT Id, first_name, last_name, address, phone, email, DOB, gender, created_At, age FROM Patients WHERE (Id = @Id)";
        ...
        public virtual int Fill(DentalDataSet7.PatientsDataTable dataTable) {
        ...
        public virtual DentalDataSet7.PatientsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DentalDataSet7.PatientsDataTable dataTable = new DentalDataSet7.PatientsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DentalDataSet7.PatientsDataTable dataTable) {
